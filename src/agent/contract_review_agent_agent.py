"""Contract Review Agent - Main Agent Implementation."""
...
class ContractReviewAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "analyze_contract": self.tools.analyze_contract,
            "identify_risks": self.tools.identify_risks,
            "compare_to_playbook": self.tools.compare_to_playbook,
            "generate_redlines": self.tools.generate_redlines,
            "extract_obligations": self.tools.extract_obligations,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['contract', 'review', 'compliance', 'audit_trail'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "compare_to_playbook": ['compare', 'to', 'playbook'],
            "generate_redlines": ['generate', 'redlines'],
