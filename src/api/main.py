"""Contract Review Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Contract review agent that analyzes legal agreements, identifies risky clauses, compares against standard terms, flags deviations from playbook, and generates redline suggestions.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
